...
```shell
python -m tests.test_glm_asr --prompt <prompt> <audio_file>
```

Use the following prompt:

`You are a home assistant. Transcribe the user audio into commands. Common
device names include: morning scene, evening scene, night scene, Mos Eisley, TV.
Common commands include: turn on, turn off, open, close, timer, set a timer,
cancel timer, timer status, what time is it.`
...
| 5 | speech_20251019_233623.wav | What day is tomorrow | What time is tomorrow? | No | FAIL |
...
| 12 | speech_20251019_211016.wav | Timer, one minute | Timmer, one minute. | No | FAIL |
...
| 15 | speech_20251019_191140.wav | Timer, one minute | TIMER 1 MINUTE | No | FAIL |
| 16 | speech_20251019_183218.wav | Set timer, one minute | Set timer one minute. | Yes | PASS |
| 17 | speech_20251020_091445.wav | What time is it? It's 9:14am | What time is it? It's nine forty there. | No | FAIL |
| 18 | speech_20251019_192430.wav | Timer, one minute | Turn on, turn off, open, close, timer, set a timer, cancel timer, timer status, what time is it? | No | FAIL |
...
| 22 | debug_20251109_185336.wav | Turn off Mos Eisley | Turn off mosquito. | No | FAIL |
